...
const chartData = reactive({
  ...
  lineData: [
    1092, 2728, 2045, 2348, 3808, 3097, 3867, 4715, 4444, 5415, 5061, 6677,
    5521, 6560, 1092, 2728, 2045, 2348, 3808, 3097, 3867, 4715, 4444, 5415,
    3097, 3867, 4715, 4444, 5415, 5061, 3677, 4521, 3808,
  ],
  barData: [
    400, 500, 500, 600, 700, 800, 900, 1500, 1000, 2500, 2200, 2450, 2250, 3300,
    400, 500, 500, 600, 700, 800, 900, 2500, 1000, 2500, 800, 900, 1500, 1000,
    2500, 2200, 2450, 2250, 700,
  ],
