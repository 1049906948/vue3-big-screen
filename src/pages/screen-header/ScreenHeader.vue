    ...
    <div class="screen-header-bottom-section">
      <div class="sub-section">
        <div class="sub-item flex-l sub-item-common-r">
          <span @click="downloadHandler('github')" class="sub-title special"
            >Github地址</span
          >
        </div>
        <div class="sub-item flex-c react-l">
          <span @click="downloadHandler('gitee')" class="sub-title special"
            >Gitee地址</span
          >
        </div>
      </div>
      ...
      <div class="sub-section">
        <div class="sub-item flex-c react-r item-special">
          <span class="sub-title">版本号：1.0.110201</span>
        </div>
...
const downloadHandler = (type: string) => {
  switch (type) {
    ...
    case "gitee":
      window.open(
        "https://gitee.com/xiaoxiang_reincarnation/vue3-big-screen.git",
      );
      break;
  }
};
