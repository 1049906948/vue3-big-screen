    ...
    <div class="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
      ...
      <div class="flex flex-1 justify-start items-start flex-col mf:mr-10">
        ...
        <button
            ...
            type="button">
          <el-icon class="text-white mr-2" color="white">
            <VideoPlay/>
          </el-icon>
        ...
        <div class="grid sm:grid-cols-3 grid-cols-2 w-full mt-10">
          <div :class="companyCommonStyles" class="rounded-tl-2xl"> Reliability</div>
          <div :class="companyCommonStyles">Security</div>
          <div :class="companyCommonStyles" class="sm:rounded-tr-2xl">Ethereum</div>
          <div :class="companyCommonStyles" class="sm:rounded-bl-2xl">web3.0</div>
          <div :class="companyCommonStyles">Low Fees</div>
          <div :class="companyCommonStyles" class="sm:rounded-br-2xl">Blockchain</div>
        </div>
      </div>
      <!--      left end-->
      <!--      right start-->
