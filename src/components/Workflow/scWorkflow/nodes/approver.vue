<template>
  <div class="node-wrap">
    ...
    <el-drawer v-model="drawer" :size="500" append-to-body destroy-on-close title="审批人设置">
      <template #header>
        ...
        <el-main style="padding:0 20px 20px 20px">
          <el-form label-position="top">
            ...
            <el-form-item v-if="form.setType==1" label="选择成员">
              <el-button icon="el-icon-plus" round type="primary" @click="selectHandle(1, form.nodeAssigneeList)">
                选择人员
              </el-button>
              <div class="tags-list">
            ...
            <el-form-item v-if="form.setType==3" label="选择角色">
              <el-button icon="el-icon-plus" round type="primary" @click="selectHandle(2, form.nodeAssigneeList)">
                选择角色
              </el-button>
              <div class="tags-list">
                <el-tag v-for="(role, index) in form.nodeAssigneeList" :key="role.id" closable type="info"
                        @close="delRole(index)">{{role.name}}
                </el-tag>
              </div>
            </el-form-item>
            ...
            <el-form-item v-if="form.setType==7" label="连续主管审批终点">
              ...
              <p v-if="form.directorMode==1">直到发起人的第
